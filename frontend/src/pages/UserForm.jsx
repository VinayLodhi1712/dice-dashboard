...
import { getFields } from '../data/fieldConfigStore';
import ModalUI from '../components/ui/Modal';
import { FieldRenderer } from '../components/ui/fieldRender';
export default function UserForm() {
  ...
  const handleSubmit = (e) => {
    ...
    Object.values(fields).forEach(field => {
      ...
      if (value && (field.fieldType === 'Text' || field.fieldType === 'Email')) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Custom Form</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {Object.values(fields).map(field => (
              <div key={field.id} className="space-y-2">
                ...
                {(field.fieldType === 'Text' || field.fieldType === 'Email') && field.minLength && field.maxLength && (
                  <p className="text-xs text-gray-500">
      ...
      >
        <pre className="whitespace-pre-wrap text-sm">{modalMessage}</pre>
